...
<div class="container">
  @include('components.parts.profile', ['imgPath' => 'img/yoshi.jpg', 'userName' => $userDataArray['name'], 'nickName' => '', 'description' => $userDataArray['company'], 'introduction' => 'Somy株式会社の人事部 吉田裕哉です。大手からベンチャーまで幅広い人事経験があります。素敵な出会いを楽しみにしております！' ])
  ...
  <h2>過去の面接</h2>
  @include('components.parts.video_content',['videosCollection' => $pastVideosCollection])
