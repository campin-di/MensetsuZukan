...
<div class="container">
  @include('components.parts.profile', ['imagePath' => $userData->image_path, 'userName' => '', 'nickName' => $userDataArray['nickname'], 'description' => $userData->company, 'introduction' => $userData->introduction])
