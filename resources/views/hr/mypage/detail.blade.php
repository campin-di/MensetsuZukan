...
<div class="container">
      ...
      <div class="acd-content">
        <div class="company_info">
          <table>
            ...
            <tr><link rel="stylesheet" href="{{ asset('css/st/mypage/detail.css') }}">
  ...
  @include('components.parts.button.transition_button',['routeName'=>'hr.mypage.detail.step1', 'var'=>'', 'text'=>'編集'])
